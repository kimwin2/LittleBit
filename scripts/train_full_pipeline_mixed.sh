...
# Output directories
STEP1_SAVE_DIR="outputs/step1_draft_0.3bit_mixed"
STEP2_SAVE_DIR="outputs/step2_residual_1.7bit_mixed"
...
# Logging
STEP1_RUN_NAME="step1_draft_0.3bit_mixed"
STEP2_RUN_NAME="step2_residual_1.7bit_mixed"
REPORT="tensorboard"
